...
Data are acquired with the external muon counter system placed in three different positions, corresponding to cosmic rays intersecting different parts of the detector.
...
The overall reconstruction efficiencies are obtained by integrating the three-dimensional plots and considering the systematic uncertainties. The efficiencies are
\begin{align*}
